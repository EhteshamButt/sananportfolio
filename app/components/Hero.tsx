...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* ── Content ── */}
      <div
        className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-10"
        style={{ zIndex: 5 }}
      >
        <div className="flex flex-col-reverse md:flex-row items-center gap-10 md:gap-0">
          ...
          <div className="w-full md:w-[48%] flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div className="flex items-center gap-5">
              <a href="https://www.instagram.com/sannan.renderz?igsh=MWVscGU4cnJxbTByYg==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-300 hover:text-pink-400 transition-colors">
              ...
              <a href="https://wa.me/923105544185" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-gray-300 hover:text-green-400 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
